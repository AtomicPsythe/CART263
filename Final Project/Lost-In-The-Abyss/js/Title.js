class Title extends Phaser.Scene {
    ...
    create() {
        ...
        // the following code between lines 24-42 was done inspired by Scarlett Perez's code
        let startButton = this.add.image(this.game.renderer.width / 1.2, this.game.renderer.height / 2.0 + 50, "startButton");
        ...
        let controlsButton = this.add.image(this.game.renderer.width / 1.19, this.game.renderer.height / 1.45 + 50, "controlsButton")
